<template>
  <div class="diary-list-container">
    ...
    <div class="pagination">
      <button @click="prevPageDiary" :disabled="currentPageDiary === 1" class="pagination-btn">上一页</button>
      <span>第 {{ currentPageDiary }} 页</span>
      <button @click="nextPageDiary" :disabled="currentPageDiary === totalDiaryPages" class="pagination-btn">下一页</button>
    </div>
