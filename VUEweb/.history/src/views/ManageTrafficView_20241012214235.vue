  ...
  export default {
    ...
    setup() {
      ...
      const getTrafficData = async () => {
        try {
          ...
          querySnapshot.docs.forEach(doc => {
            ...
            if (traffic.views === 'login') {
              loginCounts[formattedDate] = (loginCounts[formattedDate] || 0) + 1;
            } else if (traffic.views === 'register') {
              registrationCounts[formattedDate] = (registrationCounts[formattedDate] || 0) + 1;
            }
          });
      ...
      onMounted(async () => {
        ...
        createChart(document.getElementById('trafficChart').getContext('2d'), loginLabels.value, loginPoints.value, 'Daily Login Count', 'line', 'rgba(54, 162, 235, 1)', 'rgba(54, 162, 235, 0.2)');
