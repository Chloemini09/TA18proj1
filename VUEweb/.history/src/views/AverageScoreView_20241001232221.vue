<template>
    <div class="admin-container">
      ...
      <div class="admin-grid">
        <button @click="checkUserList" class="admin-button green">CHECK USER LIST</button>
        <button @click="checkUserComment" class="admin-button yellow">CHECK USER COMMENT</button>
        <router-link to="/history" class="admin-button yellow">HISTORY</router-link>
        <router-link to="/other" class="admin-button green">OTHER</router-link>
      </div>
