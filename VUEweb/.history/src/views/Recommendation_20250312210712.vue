<template>
  ...
  /* UV Index color coding - 按照参考图片颜色 */
  .uv-low .uv-gauge-tick {
    background-color: #8BC34A; /* 浅绿色: Low (1-2) */
  }
  
  .uv-medium .uv-gauge-tick {
    background-color: #FDD835; /* 黄色: Medium (3-5) */
  }
  
  .uv-high .uv-gauge-tick {
    background-color: #FB8C00; /* 橙色: High (6-7) */
  }
  
  .uv-very-high .uv-gauge-tick {
    background-color: #D32F2F; /* 红色: Very High (8-10) */
  }
  
  .uv-extreme .uv-gauge-tick {
    background-color: #7B1FA2; /* 紫色: Extremely High (11+) */
  }
