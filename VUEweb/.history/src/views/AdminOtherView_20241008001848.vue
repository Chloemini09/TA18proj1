<template>
    <div class="admin-container">
      ...
      <div class="admin-grid">
        <button @click="checkUserList" class="admin-button green">other</button>
        <button @click="checkUserComment" class="admin-button yellow">other</button>
        <router-link to="/adminhistory" class="admin-button yellow">other</router-link>
        <router-link to="/adminother" class="admin-button green">other</router-link>
      </div>
