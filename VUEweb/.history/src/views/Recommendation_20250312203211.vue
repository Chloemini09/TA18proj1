<template>
    <div class="uv-advice-container">
      <div class="banner-section" :style="{ backgroundImage: `url(${require('@/assets/recommendpage.png')})` }">
    ...
    setup() {
      ...
      async function fetchUVData() {
        ...
        try {
          ...
          const geoUrl = `https://api.openweathermap.org/geo/1.0/direct?q=${location},AU&limit=1&appid=${API_KEY}`;
          ...
          const weatherUrl = `https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&exclude=minutely,hourly,daily,alerts&appid=${API_KEY}&units=metric`;
          ...
          console.log('UV Index retrieved:', uvIndex.value);
