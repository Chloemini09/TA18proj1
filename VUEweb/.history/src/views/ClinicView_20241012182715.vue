    ...
    <div class="sidebar">
      ...
      <div v-if="nearbyClinics.length" class="clinic-list">
        ...
        <ul>
          <li
            ...
            class="clinic-item"
          >
            {{ clinic.text }} ({{ (clinic.distance / 1000).toFixed(2) }} km)
          </li>
        </ul>
      ...
      <div v-if="selectedClinic" class="route-info">
        ...
        <div class="route-options">
          <button @click="getRoute('driving')" class="route-button">驾车</button>
        ...
        <div v-if="routeInfo" class="route-summary">
          <p><strong>{{ routeInfo.mode }}</strong>: {{ routeInfo.distance }} km, {{ routeInfo.duration }} 分钟</p>
        </div>
