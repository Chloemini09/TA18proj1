<template>
  <div class="login-container" @keydown.enter="signin">
    <button class="back-btn" @click="goBack" @keydown.enter="goBack">← Back</button>
    <h1>Sign in</h1>
    ...
    <p><button @click="signin" class="form-button" @keydown.enter="signin">Sign in</button></p>
    <p v-if="errorMessage" class="error-message">{{ errorMessage }}</p>
    <p><a href="#" @click.prevent="forgotPassword" @keydown.enter="forgotPassword">Forgot your password?</a></p>
    <p><button @click="googleSignin" class="google-button" @keydown.enter="googleSignin">Sign in with Google</button></p>
    <div v-if="showModal" class="modal" @keydown.esc="goHome">
      <div class="modal-content">
        <p>Account does not exist. Would you like to register a new account?</p>
        <button @click="registerUser" @keydown.enter="registerUser">Yes, register</button>
        <button @click="goHome" @keydown.enter="goHome">No, go home</button>
      </div>
    </div>
  </div>
</template>
