  ...
  <div class="admin-dashboard-container">
    <header class="header">
      <div class="header-left">
        <h2>Hi, {{ username }}</h2>
        <p>Mending Minds, Healing Hearts</p>
      </div>
    ...
    <div class="dashboard-grid">
      ...
      <div class="dashboard-card" @click="navigateTo('/adminhistory')">
        <h3>My History</h3>
        <p>Check your history and activities</p>
      </div>

      <div class="dashboard-card" @click="navigateTo('/adminother')">
        <h3>Other</h3>
...
const username = ref('');
onMounted(() => {
  // Set username from Firestore data if available
  if (currentUser) {
