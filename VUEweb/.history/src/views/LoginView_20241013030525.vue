<template>
  <KeyboardNavigation @move="handleMove" @action="handleAction">
      <div class="login-container">
        <button class="back-btn" @click="goBack" ref="backBtn" tabindex="0">← Back</button>
        <h1>Sign in</h1>
        <p><input type="text" placeholder="Email" v-model="email" class="form-input" ref="emailInput" tabindex="0" /></p>
        <p><input type="password" placeholder="Password" v-model="password" class="form-input" ref="passwordInput" tabindex="0" /></p>
        <p><button @click="signin" class="form-button" ref="signinBtn" tabindex="0">Sign in</button></p>
        <p v-if="errorMessage" class="error-message">{{ errorMessage }}</p>
        <p><a href="#" @click.prevent="forgotPassword" ref="forgotPasswordLink" tabindex="0">Forgot your password?</a></p>
        <p><button @click="googleSignin" class="google-button" ref="googleSigninBtn" tabindex="0">Sign in with Google</button></p>
...
const handleAction = () => {
  ...
  if (activeElement === signinBtn.value) {
    signin()
  } else if (activeElement === googleSigninBtn.value) {
    googleSignin()
  } else if (activeElement === forgotPasswordLink.value) {
    forgotPassword()
  } else if (activeElement === backBtn.value) {
    goBack()
  }
}
</script>
