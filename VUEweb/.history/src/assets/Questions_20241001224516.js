const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "I used to cry, but now I can't even cry if I want to.", score: 5 }
    ]
  },
  {
    ...
    options: [
      ...
      { text: "I always feel guilty.", score: 5 }
    ]
  },
  {
    text: "How do you approach decisions?",
    options: [
      { text: "I follow through on everything I decide.", score: 5 },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "I am extremely worried about my health and cannot think about anything else.", score: 5 }
    ]
  },
  {
    text: "How do you feel about your weight?",
    options: [
      { text: "I have not felt any weight loss.", score: 5 },
  ...
  },
  {
    ...
    options: [
      { text: "I never feel like I look worse than before.", score: 5 },
  ...
  },
  {
    ...
    options: [
      { text: "I haven’t noticed any difference in my sexual life recently.", score: 5 },
  ...
  },
  {
    ...
    options: [
      { text: "I have never lost interest in others.", score: 5 },
  ...
  },
  {
    ...
    options: [
      { text: "I can work as well as before.", score: 5 },
  ...
  },
  {
    ...
    options: [
      { text: "I have never had thoughts of suicide.", score: 5 },
